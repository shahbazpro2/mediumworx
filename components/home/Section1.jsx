            ...
            <div className='md:py-20 py-10 container'>
                <div className='md:w-[750px] m-auto text-center space-y-3'>
                    ...
                    <div className="text-lg">
                        We provide a comprehensive services in customizing, deploying, and maintaining large language models, making advanced AI technology accessible and efficient for businesses of all sizes. Interested in working with us? <Link href="/contact" className='underline'>Contact our sales team.</Link>
                    </div>
                </div>
